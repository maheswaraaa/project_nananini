...
export const id = {
    ...
    hero: {
        ...
        heading: 'Merangkai Persembahan Abadi untuk Hari Istimewa Anda',
    ...
    footer: {
        ...
        copyright: '© {{year}} Nananini Wedding. Hak cipta dilindungi.',
    },
    wa: {
        general: 'Halo Nananini Wedding, saya tertarik dengan layanan hadiah pernikahan Anda. Bisakah kita mengatur konsultasi?',
        services: 'Halo Nananini Wedding, saya ingin mendiskusikan kebutuhan penataan hantaran saya.',
        seserahan: 'Halo Nananini Wedding, saya tertarik dengan layanan penataan seserahan Anda. Bisakah kita mengatur sesi konsultasi?',
    },
};
