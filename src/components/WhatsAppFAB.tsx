      ...
      {visible && (
        ...
        >
          ...
          <a
            ...
            className="relative flex items-center justify-center w-14 h-14 rounded-full bg-whatsapp hover:bg-[#20BD5A] shadow-[0_4px_16px_rgba(37,211,102,0.35)] hover:shadow-[0_6px_24px_rgba(37,211,102,0.45)] hover:scale-105 active:scale-95 transition-all duration-200"
